(function(){
		...
		function drawClock(){
			...
			cxt.arc(0,0,r-offset-cxt.lineWidth/2,2*Math.PI,false);
			cxt.stroke();
			offset+=cxt.lineWidth;
			
			cxt.lineWidth=8*rem;
			
			cxt.beginPath();
			cxt.strokeStyle='#000088';
			cxt.arc(0,0,r-offset-cxt.lineWidth/2,2*Math.PI,false);
			cxt.stroke();
			offset+=cxt.lineWidth;
			...
			hours.forEach(function(hour,i){
				...
				var x = Math.cos(rad)*(r-33*rem);
				var y = Math.sin(rad)*(r-33*rem);
		...
		function drawSecond(second){
			...
			cxt.moveTo(-2.2*rem,18*rem);
			cxt.lineTo(2.2*rem,18*rem);
			cxt.lineTo(1,-r+24*rem);
			cxt.lineTo(-1,-r+24*rem);
			cxt.fill();
